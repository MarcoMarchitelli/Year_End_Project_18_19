...
public class IntellGamePad
{
    ...
    private void CheckButtons()
    {
        ...
        Vector2 leftStickInput = new Vector2(CurrentGamePadState.ThumbSticks.Left.X, CurrentGamePadState.ThumbSticks.Left.Y);

        OnLeftStickAxesChange?.Invoke(this, leftStickInput);
        #endregion

        #region Right Stick Axes
        Vector2 rightStickInput = new Vector2(CurrentGamePadState.ThumbSticks.Right.X, CurrentGamePadState.ThumbSticks.Right.Y);
