                        ...
                        if (actionShowers[i])
                        {
                            GUILayout.BeginVertical();
                            {
                                ...
                                if (InterruptOtherActions.boolValue)
                                {
                                    ...
                                    //show list of actions to interrupt if there is any.
                                    ...
                                    {
                                        GUILayout.BeginVertical();
                                        //show list of selectable actions for current action.
                                        SerializedProperty interruptableActions = actionRef.FindPropertyRelative("InterruptableActions");

                                        EditorGUILayout.PropertyField(interruptableActions, true);
